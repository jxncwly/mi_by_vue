<template>
	<li :class="['content', content.type]"
		@mouseenter="evtMouseEnter"
    @mouseleave="evtMouseLeave">
		<h3 class="title">{{content.title}}</h3>
		<div class="slide-wrap">
			<span
				@click="slidePre()"
				:class="['slide-pre', {'slide-disable': isMouseIn && currPage === 0}]">
				<i class="fa fa-chevron-left fa-fw icon-chevron-left"></i>
			</span>
			<span
				@click="slideNext()"
				:class="['slide-next', {'slide-disable': isMouseIn && currPage === content.list.length - 1}]">
				<i class="fa fa-chevron-right fa-fw icon-chevron-right"></i>
			</span>
			<ul class="sub-content clearfix"
				:style="{'transform': 'translate(' + currPage * -296 + 'px)'}">
