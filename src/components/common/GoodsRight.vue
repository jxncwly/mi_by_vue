<template>
  <div class="goods-right">
    <ul class="goods-right-content">
      <li class="goods-right-item" v-for="(goods,index) in mostGoods" :key="index">
...
export default {
  ...
  computed: {
    mostGoods() {
      if (this.currGoods && this.currGoods.length > 1) {
        return this.currGoods.filter((v, i) => {
          return i < this.currGoods.length - 1;
        });
      } else {
        return [];
      }
