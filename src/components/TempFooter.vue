		...
		<div class="footer">
			<div class="footer-service">
				<ul class="service clearfix">
					...
					<li class="service-item">
						<a href="http://www.mi.com/service/exchange#back" target="_blank">
							<span class="icon"><i class="fa fa-history"></i></span>
							7天无条件退货
						</a>
					</li>
					<li class="service-item">
						<a href="http://www.mi.com/service/exchange#free" target="_blank">
							<span class="icon"><i class="fa fa-history"></i></span>
							15天免费换货
						</a>
					</li>
					<li class="service-item">
						<a href="http://www.mi.com/service/exchange#mail" target="_blank">
							<span class="icon"><i class="fa fa-gift"></i></span>
							满150元包邮
						</a>
					</li>
					<li class="service-item">
						<a href="http://www.mi.com/static/maintainlocation/" target="_blank">
				...
				<ul class="footer-content clearfix">
					<li class="footer-item">
						<article class="col-links">
							...
							<p>
								<a href="http://www.mi.com/service/account/register/" target="_blank">账户管理</a>
							</p>
							<p>
								<a href="http://www.mi.com/service/buy/buytime/" target="_blank">购物指南</a>

							</p>
							<p>
								<a href="http://www.mi.com/service/order/sendprogress/" target="_blank">订单操作</a>
							</p>
						</article>
					</li>
					<li class="footer-item">
						<article class="col-links">
							...
							<p>
								<a href="http://www.mi.com/service/exchange" target="_blank">售后政策</a>
							</p>
							<p>
					...
					<li class="footer-item">
						<article class="col-links">
							...
							<p>
								<a href="http://www.mi.com/static/maintainlocation/" target="_blank">服务网点</a>

							</p>
							<p>
								<a href="http://www.mi.com/static/familyLocation/" target="_blank">零售网点</a>
							</p>
						</article>
					</li>
					<li class="footer-item">
					...
					<li class="footer-item">
						<article class="col-links">
							...
							<p>
								<a href="http://order.mi.com/queue/f2code" target="_blank">F码通道</a>
							</p>
							<p>
							...
							<p>
								<a href="http://order.mi.com/misc/checkitem" target="_blank">防伪查询</a>
							</p>
						</article>
					</li>
				...
				<div class="footer-explan clearfix">
					...
					<div class="explan-content">
						<ul class="links clearfix">
							<li class="link-item"><a href="http://www.mi.com/index.html">小米商城</a></li>
						...
						<p class="explan-txt">
							©<a href="http://www.mi.com/index.html">mi.com</a> 京ICP证110507号 京ICP备10046444号 <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802020134" target="_blank">京公网安备11010802020134号 </a> <a href="http://c1.mifile.cn/f/i/2013/cn/jingwangwen.jpg" target="_blank">京网文[2014]0059-0009号</a><br/>
